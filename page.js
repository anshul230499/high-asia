...
const hillStations = [
  {slug:'shimla',name:'Shimla',state:'Himachal Pradesh',elevation:'≈ 2,200 m',identity:'Cedar ridges · heritage · mountain railway',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Shimla%20city.jpg',poem:'A city laid along a ridge, where cedar shade, winter light and the long railway climb meet the higher Himalaya.',near:'Shivalik / western Himalaya'},
  {slug:'darjeeling',name:'Darjeeling',state:'West Bengal',elevation:'≈ 2,045 m',identity:'Tea · mist · Kanchenjunga · Himalayan Railway',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Darjeeling%20town.jpg',poem:'Tea gardens fall into cloud while Kanchenjunga appears and disappears beyond the roofs — less a backdrop than a presence.',near:'Eastern Himalaya'},
  {slug:'mussoorie',name:'Mussoorie',state:'Uttarakhand',elevation:'≈ 2,000 m',identity:'Clouds · deodar · Doon Valley',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Mussoorie%20view.jpg',poem:'The ridge floats above the Doon, receiving monsoon cloud, winter sun and the first distant suggestion of snow.',near:'Garhwal Himalaya'},
  {slug:'nainital',name:'Nainital',state:'Uttarakhand',elevation:'≈ 2,084 m',identity:'Lake · forest · Kumaon',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Nainital%20lake.jpg',poem:'A green lake held in a bowl of forested hills, with Kumaon rising quietly beyond the water.',near:'Kumaon Himalaya'},
  {slug:'dharamshala',name:'Dharamshala',state:'Himachal Pradesh',elevation:'≈ 1,450–2,080 m',identity:'Dhauladhar · Tibetan culture · cedar',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Dharamshala%20and%20Dhauladhar.jpg',poem:'The Dhauladhar rises almost directly behind the town — dark forest below, white stone and snow suspended above.',near:'Dhauladhar'},
  {slug:'dalhousie',name:'Dalhousie',state:'Himachal Pradesh',elevation:'≈ 1,970 m',identity:'Pine · Pir Panjal views · old hill roads',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Dalhousie%20Himachal%20Pradesh.jpg',poem:'Five wooded hills look toward the greater ranges, their roads moving slowly through pine, mist and old stone.',near:'Western Himalaya'},
  {slug:'ooty',name:'Ooty',state:'Tamil Nadu',elevation:'≈ 2,240 m',identity:'Nilgiris · shola · mountain railway',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Ooty%20landscape.jpg',poem:'Far south of the Himalaya, the Nilgiris gather rain and cloud into shola forest, grassland and blue distance.',near:'Nilgiri Hills'},
  {slug:'kodaikanal',name:'Kodaikanal',state:'Tamil Nadu',elevation:'≈ 2,133 m',identity:'Palani Hills · lake · cloud forest',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Kodaikanal%20lake.jpg',poem:'Cloud enters the Palani Hills softly, passing over forest, water and slopes that vanish into the monsoon.',near:'Palani Hills'},
  {slug:'munnar',name:'Munnar',state:'Kerala',elevation:'≈ 1,500 m',identity:'Tea · Western Ghats · Anamudi',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Munnar%20Kerala.jpg',poem:'Tea follows the folds of the Western Ghats until cultivated green gives way to cloud and the high country of Anamudi.',near:'Western Ghats'},
  {slug:'gulmarg',name:'Gulmarg',state:'Jammu & Kashmir',elevation:'≈ 2,650 m',identity:'Meadow · snow · Pir Panjal',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Gulmarg%20Kashmir.jpg',poem:'A high meadow beneath the Pir Panjal, transformed by winter into a white field between forest and sky.',near:'Pir Panjal'},
  {slug:'kasauli',name:'Kasauli',state:'Himachal Pradesh',elevation:'≈ 1,900 m',identity:'Pine · quiet ridges · lower Himalaya',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Kasauli%20Himachal%20Pradesh.jpg',poem:'A quieter ridge of pine and long views, poised between the plains and the first serious rise of the Himalaya.',near:'Lower Himalaya'},
  {slug:'shillong',name:'Shillong',state:'Meghalaya',elevation:'≈ 1,500 m',identity:'Khasi Hills · rain · waterfalls',image:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Shillong%20Meghalaya.jpg',poem:'Rain gives the Khasi Hills their depth — water, grass and cloud shaping a highland world east of the Himalayan arc.',near:'Khasi Hills'}
]
...
export default function Home(){
  ...
  return <main>
    ...
    <header className="masthead"><button className="brand brand-button" onClick={()=>setSection('mountains')}>HIGH ASIA</button><nav className="world-nav" aria-label="High Asia sections"><button className={section==='mountains'?'active':''} onClick={()=>setSection('mountains')}>Mountains</button><button className={section==='hill-stations'?'active':''} onClick={()=>setSection('hill-stations')}>Hill Stations</button><span>Journeys</span><span>Atlas</span></nav><div className="edition">AN ATLAS OF LIFE AT ALTITUDE · HS v4 VERIFIED</div></header>
