...
const mountains = [
  { name:'Nanda Devi', range:'Himalaya', sub:'Garhwal Himalaya', elevation:'7,817 m', country:'India', firstAscent:'1936', status:'Sacred protected landscape', note:'A great summit enclosed by the Nanda Devi Sanctuary, one of the most extraordinary natural fortresses of the Himalaya.', x:47, y:58 },
  { name:'Everest', range:'Himalaya', sub:'Mahalangur Himal', elevation:'8,848.86 m', country:'Nepal / China', firstAscent:'1953', status:'World’s highest point', note:'Sagarmāthā / Qomolangma — the highest point above sea level on Earth.', x:76, y:55 },
  { name:'Khangchendzonga', range:'Himalaya', sub:'Kangchenjunga Himal', elevation:'8,586 m', country:'India / Nepal', firstAscent:'1955', status:'World’s third-highest mountain', note:'A sacred five-summit massif central to the landscape and identity of Sikkim.', x:90, y:60 },
  { name:'Annapurna I', range:'Himalaya', sub:'Annapurna Himal', elevation:'8,091 m', country:'Nepal', firstAscent:'1950', status:'First 8,000 m peak climbed', note:'A huge massif surrounded by one of the most celebrated trekking regions on Earth.', x:66, y:59 },
  { name:'Shivling', range:'Himalaya', sub:'Gangotri Group', elevation:'6,543 m', country:'India', firstAscent:'1974', status:'Sacred alpine icon', note:'A sharply sculpted peak above the Gangotri Glacier near Tapovan.', x:43, y:55 },
  { name:'K2', range:'Karakoram', sub:'Baltoro Muztagh', elevation:'8,611 m', country:'Pakistan / China', firstAscent:'1954', status:'World’s second-highest mountain', note:'K2 belongs to the Karakoram, not the Himalaya — one of the atlas’s key geographic distinctions.', x:21, y:40 },
  { name:'Kailash', range:'Transhimalaya', sub:'Gangdise Range', elevation:'6,638 m', country:'China (Tibet)', firstAscent:'Unclimbed', status:'Sacred pilgrimage mountain', note:'The central journey is the kora around the mountain, not a summit ascent.', x:55, y:43 }
]
    ...
    <main>
      ...
      <section className="mountain-page" id="nanda">
        <div className="mountain-hero">
          <div className="mountain-art"></div>
